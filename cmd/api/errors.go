...
// We'll upgrade this to use structured logging, and record additional information about the request.
...
func (app *application) errorResponse(w http.ResponseWriter, r *http.Request, status int, message interface{}) {
	...
	// If this happens to return an error then log it, and fall back to sending the client an empty response
